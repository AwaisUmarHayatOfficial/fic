            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <div class="col-md-10" >
                         <br />
                         <label><b>Clinical Faculty Update :</b>
                         ...
                         if(isset($_GET['action']) && $_GET['action'] == 'update'){
                            ...
                            $id = $_GET['id'];
                            $sdau = mysql_query("select * from faculity where id='$id' ");
                            $chec = mysql_fetch_array($sdau);
                         
                         
                         ?>
                         
                         <form method="post" action="admin-page-settingbl.php?action=adf-update&att=up&id=<?php echo $id; ?>" onsubmit="return myForm()" enctype="multipart/form-data">
                         
                         <label>Name : <span style="color: #ff0000;" id="error_na"></span></label>
                         <input type="text" name="name_f" id="name_f" value="<?php echo @$chec['name_f']; ?>" id="name_f" class="form-control" onfocus="clr('error_na')" /><br />
                         
                         <label>Attahed Photo : </label>
                         <img width="80px" src="images/<?php echo $chec['ph_f']; ?>" /><br />
                         
                         <label>Photo : </label>
                         <input type="file" name="ph_f" id="ph_f" class="btn btn-upload" /><br />
                         
                         </div>
                         <div class="col-md-4">
                         
                         <label>Department : <span style="color: #ff0000;" id="error_dep"></span></label>
                         <select name="dep_f" class="form-control">
                          <option value="<?php echo @$chec['dep_f']; ?>"><?php echo @$chec['dep_f']; ?></option>
                          <?php
                            $sele = mysql_query("select * from department");
                            while($dep = mysql_fetch_array($sele)){
                            
                          ?>
                          <option value="<?php echo $dep['department']; ?>"><?php echo $dep['department']; ?></option>
                         <?php
                         }
                         ?>
                         </select><br />
                         ...
                         <label>Order :</label>
                         <input type="number" name="order_dep" value="<?php echo @$chec['order_dep']; ?>" id="order_dep" class="form-control"  /><br />
                         
                         <label>Designation : <span style="color: #ff0000;" id="error_des"></span></label>
                         <textarea name="des_f" id="des_f" class="form-control" onfocus="clr('error_des')" ><?php echo @$chec['des_f']; ?></textarea><br />
                         
                         <label>Designation Note : <span style="color: #ff0000;" id="error_note"></span></label>
                         <textarea name="des_note" id="des_note" class="form-control" onfocus="clr('error_note')" ><?php echo @$chec['des_note']; ?></textarea><br />
