          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                         <a href="admin-reports-add.php?page=<?php echo $_GET['page']; ?>"><input type="button" class="btn btn-upload " value="Add Report" /></a>
                                        ...
                                        <tbody>  	 	 	
                                            ...
                                            $tenders = mysql_fetch_array($qry);
                                          	if($tenders == '')
                                                ...
                                                $qrry = mysql_query("select * from report order by id desc limit $page1,10");
                                        		...
                                        		?> 
                                                    <tr>
                                                        ...
                                                        <td align="center"><?php echo $tender->report_title;?></td>
                                                        <td align="center"><?php echo $tender->st_date;?></td>
                                                        <td align="center"><?php echo $tender->last_date; ?></td>
                                                        <td align="center"><?php echo $tender->file_link;?></td>
                                                        <td align="center"><?php echo ($tender->publish_status ? '<a href="admin-reportsbl.php?action=unpublish&id='.$tender->id.'&page='.$pages.'"><img src="images/tick.png" border="0"></a>' : '<a href="admin-reportsbl.php?action=publish&id='.$tender->id.'&page='.$pages.'"><img src="images/publish_x.png" border="0"></a>')?></td>
                                                    	<td align="center"><a style="color: blue;" target="_blank" href="files/<?php echo $tender->file_link;?>">View</a></td>
                                                        <td align="center"><a style="color: blue;" href="files/<?php echo $tender->file_link;?>" download>Download</a></td>
                                                        <td align="center"><a href="admin-reports-update.php?action=update&id=<?php echo($tender->id);?>&page=<?php echo $pages ;?>"><img src="images/edit.gif" border="0"/></a></td>
                                                        <td align="center"><a href="admin-reportsbl.php?action=delete&id=<?php echo($tender->id);?>&page=<?php echo $pages ;?>" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                                    </tr>
                                                <?php 
                                                  }
                                      ...
                                      $query = mysql_query("select * from report");
                                                    ...
                                                    for($b=1; $b<=$a; $b++){
                                                        ...
                                                        ?><div class="btn-group">
                                                             ...
                                                             <a class="btn <?php echo $class ;?>" href="admin-reports.php?page=<?php echo $b ;?>" style="text-decoration: none;" ><?php echo $b." ";?></a>
