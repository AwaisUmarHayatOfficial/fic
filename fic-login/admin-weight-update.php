          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                  <h3  style="font-size: 26px !important;" class="fa fa-bookmark"> Update Widgets<small> (Update)</small></h3>
                </div>
                         ...
                         <div class="x_content">
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      if(isset($_GET['action']) && $_GET['action'] == 'update'){
                                        $pages = $_GET['page'];
                                        $id = $_GET['id'];
                                        $query = mysql_query("select * from weight where id='$id' ");
                                        $data = mysql_fetch_assoc($query);
                                      ?>
                                  <form  method="post" action="admin-weightbl.php?action=updated&att=up&page=<?php echo $pages ;?>&id=<?php echo $id; ?>" onsubmit="return myForm()" enctype="multipart/form-data" >
                                     ...
                                     <input class="form-control" onfocus="clr('error_title')" value="<?php echo @$data['title_w']?>"  type="text" id="title_w" name="title_w" /><br />
                                     
                                     <label>Image :* </label><br />
                                     <span>Attahed image:</span>
                                     <img width="120px" src="images/<?php echo @$data['image_w']?>" />
                                     <input class="btn btn-upload" onfocus="clr('error_img')"  type="file" id="image_w" name="image_w" /><br />
                                      
                                     <label>Select Row :* <span class="error" id="error_row"></span></label><br />
                                     <select class="form-control input-sm" name="line_w">
                                       <option value="<?php echo @$data['line_w'] ?>"><?php echo @$data['line_w'] ?></option>
                                    ...
                                    <label>Content :* </label>
                                    <textarea name="content_w" id="Text_1"><?php echo @$data['content_w']?></textarea><br />
                                     
                                    
                                     
                                    <input type="submit" name="jobs_submit" value="Update Widgets" class="btn btn-primary" />
  ...
  <script type="text/javascript" >
    function myForm(){
            ...
            if(line_w =='' || title_w == ''){
                ...
                $('title_w='+title_w+'&line_w='+line_w+'',function(data){
                $('.line_w').val('');
                $('.title_w').val('');
