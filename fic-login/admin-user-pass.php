          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                <h3  style="font-size: 26px !important;" class="fa fa-users"> User Forget Password<small></small></h3>
                </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                ?>
                         ...
                         <?php
                         if(isset($_GET['action']) && $_GET['action'] == 'forpass'){
                       ...
                       <form method="post" onsubmit="return myForm()" action="admin-siteuserbll.php?action=change&id=<?php echo $id; ?>&page=<?php echo $pg;?>">
                       ...
                       if(isset($_GET['action']) && $_GET['action'] == 'pnm'){
                ...
                <div class="x_content">
                       ...
                       <form method="post" onsubmit="return myForm()" action="admin-siteuserbll.php?action=user_ch&id=<?php echo $user; ?>&page=<?php echo $pg;?>">
                       
                       
                       
                       <div class="col-md-4" >
                       <label>Old Password : <span style="color: #ff0000 ;" id="error_old"></span></label>
                       <input type="password" name="old_pass" onfocus="clr('error_old')" id="old_pass" class="form-control" /><br />
                       <label>New Password : <span style="color: #ff0000 ;" id="error_new"></span></label>
                       <input type="password" name="new_pass" onfocus="clr('error_new')" id="new_pass" class="form-control" /><br />
                       <label>Confirm Password : <span style="color: #ff0000 ;" id="error_cf"></span></label>
                       <input type="password" name="cf_pass" onfocus="clr('error_cf')" id="cf_pass" class="form-control" /><br />
