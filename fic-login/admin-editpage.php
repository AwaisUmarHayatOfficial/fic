            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                          ...
                          <form method="post" onsubmit="return myForm()" action="admin-add-pagebl.php?action=updated&id=<?php echo $id ; ?>&page=<?php echo $pg;?>" >
                    
                                        <div class="form-group">
                                            <label>Enter Page Name <span id="error_tit" style="color: #ff0000;"></span></label>
                                            <input type="text" class="form-control" value="<?php echo @$data['title']; ?>" onfocus="clr('error_tit')" id="title" name="title" placeholder="Enter Page Title" />
                                        </div>
                                        <div class="form-group">
                                            <label>Page Content</label>
                                            <textarea  name="content" id="Text_1"><?php echo @$data['content']; ?></textarea>
                                            <br />
