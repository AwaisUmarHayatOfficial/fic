...
function(a) {
			...
			if (!this.fakeEmpty(i)) if (f = "n" == b ? this.options.paragraphy ? a("<p>").html(i.html()) : i.html() + "<br/>" : a("<" + b + ">").html(i.html()), i.get(0) == this.$element.get(0) || g(f)) i.html(f);
				...
				try {
					...
					if (i.hasClass(c) && i.get(0).tagName.toLowerCase() === b) f.addClass(i.attr("class")).removeClass(c);
						...
						for (var m = i.attr("class").split(" "), n = 0; n < m.length; n++) {
	...
	a.Editable.prototype.getBoundingRect = function() {
		...
		if (this.options.inlineMode || b) {
			...
			if (c = this.getBoundingRect(), this.showBttnWrapper(), c.ok || c.left >= 0 && c.top >= 0 && c.right > 0 && c.bottom > 0) d = c.left + c.width / 2, e = c.top + c.height, this.iOS() && this.iOSVersion() < 8 || (d += a(window).scrollLeft(), e += a(window).scrollTop()), this.showByCoordinates(d, e);
	...
	a.Editable.image_commands = {
		...
		imageUploadURL: url_ak+'upload_images.php',
		...
		for (var b = a('<div class="f-popup-line f-popup-toolbar">').appendTo(this.$image_editor), c = 0; c < this.options.imageButtons.length; c++) {
			...
			if (void 0 !== a.Editable.image_commands[d]) {
				...
				var e = a.Editable.image_commands[d],
					...
					f = '<button class="fr-bttn" data-callback="' + d + '" data-cmd="' + d + '" title="' + e.title + '">';
		...
		var e = '<img class="fr-fin fr-just-inserted" alt="' + this.options.defaultImageTitle + '" src="' + b + '"' + d + ">",

			f = this.getSelectionElements()[0],

			g = this.getRange(),

			h = !this.browser.msie && a.Editable.getIEversion() > 8 ? a(g.startContainer) : null;
	...
	a.Editable.prototype.browserFixes = function() {
		...
		this.$element.on("keydown", a.proxy(function(b) {
			...
			var d = b.which,
				...
				e = a(this.getSelectionElements()[0]);
