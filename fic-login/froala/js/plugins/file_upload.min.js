...
function(a) {
      ...
      var url_ak = document.URL;

        url_ak = url_ak.substring(0, url_ak.lastIndexOf("/") + 1);
	...
	a.Editable.commands = a.extend(a.Editable.commands, {
		...
		fileUploadURL: url_ak+'upload_images.php',
