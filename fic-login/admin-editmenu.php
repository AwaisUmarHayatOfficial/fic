          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <br />
               <label style="color: #1ABB9C !important;">1) <a style="color: #1ABB9C !important;" href="admin-editmenu.php?page=<?php echo $_GET['page'];?>">Pages Link</a></label><br />
               <br />
               <label >2) <a href="admin-custom-link.php?page=">Custom Link</a></label>
               </div>
               ...
               <table class="table table-bordered" style="text-align: center !important; " >
                 ...
                 $spm = mysql_query("select * from pages  where publish_status='1' and custom_menu='page' order by id desc limit $page1,10  ");
              ...
              for($i=1; $i<=$rows; $i++){
                ...
                $spmch = mysql_fetch_object($spm);
                 ...
                 <tbody>
                   ...
                   <td style="text-align: center;"><?php $menue = str_replace('-',' ',$spmch->menun);
                   echo ucfirst($menue);
                     ?></td>
                     <td style="text-align: center;"><?php echo $spmch->order_m; ?></td>
                   <td align="center"><a href="admin-pages-link-update.php?action=update&id=<?php echo($spmch->id);?>&page=<?php echo $_GET['page']; ?>"><img src="images/edit.gif" border="0"/></a></td>
                                      ...
                                      $query = mysql_query("select * from pages where custom_menu='page'");
                                                    ...
                                                    for($b=1; $b<=$a; $b++){
                                                        ...
                                                        ?><div class="btn-group">
                                                             ...
                                                             <a class="btn <?php echo $class;?>" href="admin-editmenu.php?page=<?php echo $b ;?>" style="text-decoration: none;" ><?php echo $b." ";?></a>
