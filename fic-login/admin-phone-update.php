            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <div class="col-md-4" >
                         <br />
                         <label><b>Phone Number : </b><span style="color: #ff0000;" id="error_cp"></span></label><br /><br />
                         
                         <?php
                         if(isset($_GET['action']) && $_GET['action'] == 'update'){
                            
                         
                         $cps = mysql_query("select * from phone");
                         if($cpc = mysql_fetch_array($cps)){
                         ?>
                         <form action="admin-settingbl.php?action=ph-update" onsubmit="return myForm()" method="post">
                         
                         <input onfocus="clr('error_cp')" value="<?php echo @$cpc['phone_s'];  ?>" type="text" name="phone_s" id="phone_s" />
                         <br />
                         <br />
