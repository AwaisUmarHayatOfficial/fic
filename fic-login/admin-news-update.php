          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                  <h3  style="font-size: 26px !important;" class="fa fa-newspaper-o"> Update News<small> (update)</small></h3>
                </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <div class="x_content">
                                  ...
                                  <form  method="post" action="admin-newsbl.php?action=updated&id=<?php echo $id ;?>&att=up&page=<?php echo $pages ;?>" onsubmit="return myForm()" enctype="multipart/form-data" >
                                  
                                  <div class="col-md-8">
                                     <label>&nbsp;<span class="error" id="error_date"></span></label><br />
                                    <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                    <input id="single_cal2" onfocus="clr('error_date')" value="<?php $date = date_create($data['date']);
                                    echo date_format($date,"m/d/20y");
                                     ?>" name="date" class="form-control has-feedback-left" type="text" aria-describedby="inputSuccess2Status2" placeholder="Date:*">
                                    <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                    <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                                    </div>
                                     
                                     <label>News Title :* <span class="error" id="error_title"></span></label>
                                     <input class="form-control" onfocus="clr('error_title')" value="<?php echo @$data['title']; ?>" type="text" id="title" name="title" /><br />
                                     

                                    <label>Description :* <span class="error" id="error_des"></span></label>
                                    <textarea id="Text_1" name="description"><?php echo @$data['description']; ?></textarea>
                                    
                                   <br />
                                     
                                    <input type="submit" name="jobs_submit" value="update News" class="btn btn-primary" />
                                    </div>
