            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <a href="admin-add-administration.php?page="><input type="button" class="btn btn-upload " value="Add Admin Team" /></a>
                         <table class="table table-bordered" style="text-align: center !important; ">
                             ...
                             <thead>
                                          ...
                                          <th style="text-align: center !important; " >ID</th>
                                           ...
                                           <th style="text-align: center !important; ">Education</th>
                              ...
                              <?php
                              $qrry = mysql_query("select * from administration ");
                              ...
                              <tbody>
                                ...
                                <td align="center"><?php echo $tender->name_a; ?></td>
                                <td align="center"><?php echo $tender->des_a; ?></td>
                                <td align="center"><?php echo $tender->edu_a; ?></td>
                                <td align="center"><?php echo $tender->con_a; ?></td>
                                <td align="center"><img width="80px" src="images/<?php if($tender->ph_a == ''){
                                    echo 'profile.jpg';
                                }else{
                                  echo $tender->ph_a;
                                } ?>" /></td>
                                <td align="center"><?php echo ($tender->publish_status ? '<a href="admin-page-settingbl.php?action=ads-unpublish&id='.$tender->id.'&page"><img src="images/tick.png" border="0"></a>' : '<a href="admin-page-settingbl.php?action=ads-publish&id='.$tender->id.'&page"><img src="images/publish_x.png" border="0"></a>')?></td>
                               	<td align="center"><a href="admin-administration-update.php?action=update&id=<?php echo($tender->id); ?>"><img src="images/edit.gif" border="0"/></a></td>
                                <td align="center"><a href="admin-page-settingbl.php?action=ads-delete&id=<?php echo($tender->id);?>&page" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                </tbody>
                            <?php
                            }
