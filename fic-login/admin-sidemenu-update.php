          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                  <h3  style="font-size: 26px !important;" class="fa fa-newspaper-o"> Update Breaking News<small> (update)</small></h3>
                </div>
                         ...
                         <div class="col-md-1" >
                                    ...
                                    <?php
                                       if(isset($_GET['action']) && $_GET['action'] == 'update'){
                                        $pages = $_GET['page'];
                                        $id = $_GET['id'];
                                        $query = mysql_query("select * from sidemenu where id='$id' ");
                                        $data = mysql_fetch_assoc($query);
                                    
                                    ?>
                                      
                                  <form  method="post" action="admin-settingbl.php?action=sm-update&id=<?php echo $id; ?>" onsubmit="return myForm()" enctype="multipart/form-data" >
                                  
                                  <div class="col-md-8">
                                     <label>&nbsp;<span class="error" id="error_date"></span></label><br />
                                    <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                    <input id="single_cal2" onfocus="clr('error_date')" value="<?php echo @$data['date_bn']; ?>" name="date_bn" class="form-control has-feedback-left" type="text" aria-describedby="inputSuccess2Status2" placeholder="Date:*">
                                    <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                    <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                                    </div>
                                     
                                     <label>News Title :* <span class="error" id="error_title"></span></label>
                                     <input class="form-control" onfocus="clr('error_title')" value="<?php echo @$data['title_bn']; ?>" type="text" id="title" name="title_bn" /><br />
                                     

                                    <label>Description :* <span class="error" id="error_des"></span></label>
                                    <textarea id="Text_1" name="content_bn"><?php echo @$data['content_bn']; ?></textarea>
                                    
                                   <br />
                                     
                                    <input type="submit" name="jobs_submit" value="Update" class="btn btn-primary" />
                                    </div>
