              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         if(isset($_GET['action']) && $_GET['action'] == 'update'){
                            ...
                            $id = $_GET['id'];
                            $sdau = mysql_query("select * from department where id='$id' ");
                            $chec = mysql_fetch_array($sdau);
                         
                         
                         ?>
                         
                         <form method="post" action="admin-settingbl.php?action=dep-update&att=up&id=<?php echo $id; ?>" onsubmit="return myForm()" enctype="multipart/form-data">
                         
                         <label>Department : <span style="color: #ff0000;" id="error_na"></span></label>
                         <input type="text" name="department" value="<?php echo @$chec['department']; ?>" id="name_f" class="form-control" onfocus="clr('error_na')" /><br />
                         
                         <label>Order :</span></label>
                         <input type="number" name="order_d"  value="<?php echo @$chec['order_d']; ?>" class="form-control"  /><br />
