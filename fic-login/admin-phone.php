            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <br />
                         <label style="color: #1ABB9C !important;">2)<a style="color: #1ABB9C !important;" href="admin-phone.php?page="> Phone</a></label><br />
                         <br />
                         ...
                         <table class="table table-bordered" style="text-align: center !important; ">
                             ...
                             <thead>
                                          <tr>
                                            ...
                                            <th style="text-align: center !important; " >Number</th>
                             ...
                             <tbody>
                              <?php
                              $qrry = mysql_query("select * from phone");
                              while($tender = mysql_fetch_array($qrry)){
                              
                              ?>
                                 <td align="center"><?php echo $tender['id']; ?></td>
                                <td align="center"><?php echo $tender['phone_s']; ?></td>
                                <td align="center"><?php echo ($tender['publish_status'] ? '<a href="admin-settingbl.php?action=ph-unpublish&id='.$tender['id'].'&page"><img src="images/tick.png" border="0"></a>' : '<a href="admin-settingbl.php?action=ph-publish&id='.$tender['id'].'&page"><img src="images/publish_x.png" border="0"></a>')?></td>
                               	<td align="center"><a href="admin-phone-update.php?action=update&page"><img src="images/edit.gif" border="0"/></a></td>
                            <?php
                            }
