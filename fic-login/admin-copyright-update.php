...
<body class="nav-md">
            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <div class="col-md-4" >
                         <br />
                         <label><b>Copyright : </b><span style="color: #ff0000;" id="error_cp"></span></label><br /><br />
                         
                         <?php
                         if(isset($_GET['action']) && $_GET['action'] == 'update'){
                            
                         
                         $cps = mysql_query("select * from copyright");
                         if($cpc = mysql_fetch_array($cps)){
                         ?>
                         <form action="admin-settingbl.php?action=cp-update" onsubmit="return myForm()" method="post">
                         
                         <textarea onfocus="clr('error_cp')" style="height: 80px;" id="text_c" name="text_c"><?php echo @$cpc['text_c'];  ?></textarea><br />
                         <br />
  ...
  <script type="text/javascript" src="js/flot/curvedLines.js"></script>
    ...
    function myForm(){
            ...
            var text_c = $('#text_c').val();
            
            if(text_c == ''){
                $('#error_cp').html('(Empty)');
            }else{
                $('text_c='+text_c+'',function(data){
                $('.text_c').val('');
