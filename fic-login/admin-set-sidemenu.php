            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <br />
                         <label style="color: #1ABB9C !important;" >3)<a style="color: #1ABB9C !important;" href="admin-set-sidemenu.php?page="> Breaking News</a></label><br />
                         <br />
                         <label>4)<a href="admin-set-sideweight.php?page="> Side Widgets</a></label><br />
                         <br />
                         ...
                         <table class="table table-bordered" style="text-align: center !important; ">
                               ...
                               <thead>
                                          <tr>
                                            ...
                                            <th style="text-align: center !important; " >News Title</th>
                                            <th style="text-align: center !important; " >News Content</th>
                                   ...
                                   <?php
                            $qry = mysql_query("select * from sidemenu");
                            $tenders = mysql_fetch_array($qry);
                              ...
                              $qrry = mysql_query("select * from sidemenu order by id desc limit 0,1");
                              ...
                              ?>
                              <tbody>
                                <td align="center"><?php echo $tender->date_bn; ?></td>
                                <td align="center"><?php echo $tender->title_bn; ?></td>
                                <td align="center"><?php 
                                                $text = $tender->content_bn;
                                                 $text = trim( $text );
                                                    $small = $text;
                                                    if( strlen( $text ) > 100 ){
                   ...
                   ?>...</td>
                                <td align="center"><?php echo ($tender->publish_status ? '<a href="admin-settingbl.php?action=sm-unpublish&id='.$tender->id.'&page"><img src="images/tick.png" border="0"></a>' : '<a href="admin-settingbl.php?action=sm-publish&id='.$tender->id.'&page"><img src="images/publish_x.png" border="0"></a>')?></td>
                               	<td align="center"><a href="admin-sidemenu-update.php?action=update&id=<?php echo($tender->id);?>&page"><img src="images/edit.gif" border="0"/></a></td>
                                <td align="center"><a href="admin-settingbl.php?action=delete&id=<?php echo($tender->id);?>&page" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                            </tbody>
                            <?php
                            }
