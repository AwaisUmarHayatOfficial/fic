          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                  <h3  style="font-size: 26px !important;" class="fa fa-bookmark"> Widgets<small> (List)</small></h3>
                </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                        ...
                        $pg = $_GET['page'];
                        ?>
                         <a href="admin-weight-add.php?page=<?php echo $pg ; ?>"><input type="button" class="btn btn-upload " value="Add Widgets" /></a>
                      ...
                      <table class="table table-bordered" style="text-align: center !important; " >
                                        ...
                                        <tbody>  	 	 	
                                             ...
                                             <?php
                                            $qry = mysql_query("select * from weight");
                                            $tenders = mysql_fetch_array($qry);
                                          	if($tenders == '')
                                                ...
                                                $qrry = mysql_query("select * from weight limit $page1,10");
                                        		...
                                        		?> 
                                                    <tr>
                                                        ...
                                                        <td align="center"><img width="120px" src="images/<?php echo $tender->image_w;?>" /></td>
                                                        <td><?php echo $tender->title_w;?></td>
                                                        <td align="center"><?php 
                                              
                                                  $text = $tender->content_w;  
                                                 $text = trim( $text );
                                                    $small = $text;
                                                    if( strlen( $text ) > 80 ){
                                                    $small = mb_substr( $small, 0, 80 );
                                               ...
                                               ?> ...
                                                        ...
                                                        <td align="center"><?php echo $tender->line_w;?></td>
                                                        <td align="center"><?php echo ($tender->publish_status ? '<a href="admin-weightbl.php?action=unpublish&id='.$tender->id.'&page='.$pages.'"><img src="images/tick.png" border="0"></a>' : '<a href="admin-weightbl.php?action=publish&id='.$tender->id.'&page='.$pages.'"><img src="images/publish_x.png" border="0"></a>')?></td>
                                                    	<td align="center"><a href="admin-weight-update.php?action=update&id=<?php echo($tender->id);?>&page=<?php echo $pages ;?>"><img src="images/edit.gif" border="0"/></a></td>
                                                        <td align="center"><a href="admin-weightbl.php?action=delete&id=<?php echo($tender->id);?>&page=<?php echo $pages ;?>" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                                    </tr>
                                                <?php 
                                                  }
                              ...
                              <?php
                                      $query = mysql_query("select * from weight");
                                                    ...
                                                    for($b=1; $b<=$a; $b++){
                                                        ...
                                                        ?><div class="btn-group">
                                                             ...
                                                             <a class="btn <?php echo $class ;?>" href="admin-weight.php?page=<?php echo $b ;?>" style="text-decoration: none;" ><?php echo $b." ";?></a>
