              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         ?>
                          ...
                          <a href="admin-add-dep-faculity.php?page="><input type="button" class="btn btn-upload " value="Add Department" /></a>
                         <table class="table table-bordered" style="text-align: center !important; ">
                             ...
                             <thead>
                              ...
                              <?php
                              $qrry = mysql_query("select * from department  ");
                              ...
                              <tbody>
                                ...
                                <td align="center"><?php echo $tender->department; ?></td>
                                <td align="center"><?php echo $tender->order_d; ?></td>
                               	<td align="center"><a href="admin-faculity-dep-update.php?action=update&id=<?php echo($tender->id); ?>"><img src="images/edit.gif" border="0"/></a></td>
                                <td align="center"><a href="admin-settingbl.php?action=dep-delete&id=<?php echo($tender->id);?>&page" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                </tbody>
                            <?php
                            }
