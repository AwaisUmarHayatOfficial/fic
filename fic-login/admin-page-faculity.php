            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         if(isset($_GET['action']) && $_GET['action'] == 'rns'){
                            
                            echo '<b style="color:#ff0000;">Not Saved.</b>';
                         }
                         ...
                         <a href="admin-add-faculity.php?page="><input type="button" class="btn btn-upload " value="Add Clinical Faculty" /></a>
                          <a href="admin-dep-faculity.php?page="><input type="button" class="btn btn-upload " value="Departments" /></a>
                         <table class="table table-bordered" style="text-align: center !important; ">
                             ...
                             <thead>
                                          ...
                                          <th style="text-align: center !important; ">Department</th>
                                           <th style="text-align: center !important;" colspan="2" >Name / Designation</th>
                                           <th style="text-align: center !important; ">Designation Note</th>
                              ...
                              <?php
                              $qrry = mysql_query("select * from faculity  ");
                              ...
                              <tbody>
                                ...
                                <td align="center"><?php echo $tender->dep_f; ?></td>
                                <td align="center"><?php echo $tender->name_f; ?></td>
                                <td align="center"><?php echo $tender->des_f; ?></td>
                                <td align="center"><?php echo $tender->des_note; ?></td>
                                <td align="center"><?php echo $tender->order_dep; ?></td>
                                <td align="center"><img width="80px" src="images/<?php if($tender->ph_f == ''){
                                    echo 'profile.jpg';
                                }else{
                                  echo $tender->ph_f;
                                } ?>" /></td>
                                <td align="center"><?php echo ($tender->publish_status ? '<a href="admin-page-settingbl.php?action=adsf-unpublish&id='.$tender->id.'&page"><img src="images/tick.png" border="0"></a>' : '<a href="admin-page-settingbl.php?action=adsf-publish&id='.$tender->id.'&page"><img src="images/publish_x.png" border="0"></a>')?></td>
                               	<td align="center"><a href="admin-faculity-update.php?action=update&id=<?php echo($tender->id); ?>"><img src="images/edit.gif" border="0"/></a></td>
                                <td align="center"><a href="admin-page-settingbl.php?action=adsf-delete&id=<?php echo($tender->id);?>&page" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                </tbody>
                            <?php
                            }
