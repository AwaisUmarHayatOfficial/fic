          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                  <h3  style="font-size: 26px !important;" class="fa fa-edit"> Tender Manager<small> (List)</small></h3>
                </div>
                ...
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                        ...
                        ?>
                         ...
                         <div class="x_content">
                                  ...
                                  <a href="admin-tender-add.php?page=<?php echo $_GET['page']; ?>"><input type="button" class="btn btn-upload " value="Add Tender" /></a>
                                   ...
                                   if(isset($_GET['action']) && $_GET['action'] == 'ts' ){
                                    
                                    echo '<b style="color:green;" >Record Saved.</b>';
                                    
                                   }
                                   if(isset($_GET['action']) && $_GET['action'] == 'tus' ){
                                   ...
                                   <table class="table table-bordered" style="text-align: center !important; " >
                                        <thead>
                                          <tr>
                                            ...
                                            <th style="text-align: center !important; " >Tender Fee</th>
                                            <th style="text-align: center !important; " >CDR</th>
                                            <th style="text-align: center !important; " >Advertisement File Name</th>
                                        ...
                                        <tbody>
                                        <?php
                                            $qry = mysql_query("select * from tender");
                                            $tenders = mysql_fetch_array($qry);
                                          	if($tenders == '')
                                                ...
                                                $qrry = mysql_query("select * from tender order by id desc limit $page1,10  ");
                                        		...
                                        		?> 
                                                    <tr>
                                                        ...
                                                        <td><?php echo $tender->item_description;?></td>
                                                        <td align="center"><?php echo $tender->st_adv_date;?></td>
                                                        <td align="center"><?php echo $tender->last_adv_date; ?></td>
                                                        <td align="center"><?php echo $tender->free; ?></td>
                                                        <td align="center"><?php echo $tender->cdr; ?></td>
                                                        <td align="center"><?php echo $tender->att_file;?></td>
                                                        <td align="center"><?php echo ($tender->publish_status ? '<a href="admin-tenderbl.php?action=unpublish&id='.$tender->id.'&page='.$pages.'"><img src="images/tick.png" border="0"></a>' : '<a href="admin-tenderbl.php?action=publish&id='.$tender->id.'&page='.$pages.'"><img src="images/publish_x.png" border="0"></a>')?></td>
                                                        <td align="center"><a style="color: blue;" target="_blank" href="files/<?php echo $tender->att_file;?>" >View</a></td>
                                                        <td align="center"><a style="color: blue;" href="files/<?php echo $tender->att_file;?>" download>Download</a></td>
                                                    	<td align="center"><a href="admin-tender-update.php?action=update&id=<?php echo($tender->id);?>&page=<?php echo $pages ; ?>"><img src="images/edit.gif" border="0"/></a></td>
                                                        <td align="center"><a href="admin-tenderbl.php?action=delete&id=<?php echo($tender->id);?>&page=<?php echo $pages ; ?>" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                                    </tr>
                                                <?php 
                                                  }
                                      ...
                                      <?php
                                      $query = mysql_query("select * from tender");
                                                    ...
                                                    for($b=1; $b<=$a; $b++){
                                                        ...
                                                        ?><div class="btn-group">
                                                             ...
                                                             <a class="btn <?php echo $class;?>" href="admin-tender.php?page=<?php echo $b ;?>" style="text-decoration: none;" ><?php echo $b." ";?></a>
