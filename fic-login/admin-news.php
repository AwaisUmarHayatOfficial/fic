          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                  <h3  style="font-size: 26px !important;" class="fa fa-newspaper-o"> News Manager<small> (List)</small></h3>
                </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                         <a href="admin-news-add.php?page="><input type="button" class="btn btn-upload " value="Add News" /></a>
                                        ...
                                        <tbody>  	 	 	
                                            ...
                                            $tenders = mysql_fetch_array($qry);
                                          	if($tenders == '')
                                                ...
                                                $qrry = mysql_query("select * from news order by date desc limit $page1,10");
                                        		...
                                        		?> 
                                                    <tr>
                                                        ...
                                                        <td align="center"><?php $date = date_create($tender->date);
                                                        echo date_format($date,"d/m/20y");
                                                        ?></td>
                                                        <td align="center"><?php 
                                              
                                                
                                                 $string = trim( $tender->description );
                                               ...
                                               ?>
                                                        ...
                                                        <td align="center"><?php echo ($tender->publish_status ? '<a href="admin-newsbl.php?action=unpublish&id='.$tender->id.'&page='.$pages.'"><img src="images/tick.png" border="0"></a>' : '<a href="admin-newsbl.php?action=publish&id='.$tender->id.'&page='.$pages.'"><img src="images/publish_x.png" border="0"></a>')?></td>
                                                    	<td align="center"><a href="admin-news-update.php?action=update&id=<?php echo($tender->id);?>&page=<?php echo $pages ;?>"><img src="images/edit.gif" border="0"/></a></td>
                                                        <td align="center"><a href="admin-newsbl.php?action=delete&id=<?php echo($tender->id);?>&page=<?php echo $pages ;?>" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                                    </tr>
                                                <?php 
                                                  }
                                      ...
                                      $query = mysql_query("select * from news");
                                                    ...
                                                    for($b=1; $b<=$a; $b++){
                                                        ...
                                                        ?><div class="btn-group">
                                                             ...
                                                             <a class="btn <?php echo $class ;?>" href="admin-news.php?page=<?php echo $b ;?>" style="text-decoration: none;" ><?php echo $b." ";?></a>
