            ...
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <div class="col-md-4">
                         <form method="post" action="admin-page-settingbl.php?action=adf-save" onsubmit="return myForm()" enctype="multipart/form-data">
                         
                         <label>Name : <span style="color: #ff0000;" id="error_na"></span></label>
                         <input type="text" name="name_f" id="name_f" class="form-control" onfocus="clr('error_na')" /><br />
                         
                         <label>Order :</label>
                         <input type="number" name="order_dep" id="order_dep" class="form-control"  /><br />
                         
                         <label>Photo :</label>
                         <input type="file" name="ph_f" id="ph_f" class="btn btn-upload"  />
                         ...
                         <textarea name="des_f" id="des_f" class="form-control" onfocus="clr('error_des')" ></textarea><br />
                         
                         <label>Designation Note : <span style="color: #ff0000;" id="error_note"></span></label>
                         <textarea name="des_note" id="des_note" class="form-control" onfocus="clr('error_note')" ></textarea><br />
