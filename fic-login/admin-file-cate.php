          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                ?>
                <div class="x_content">
                         <a href="admin-file-add-cate.php?page=<?php echo $_GET['page']; ?>"><input type="button" class="btn btn-upload " value="Add File Category" /></a>
                      ...
                      <table class="table table-bordered" style="text-align: center !important; " >
                                        <thead>
                                          <tr>
                                            ...
                                            <th style="text-align: center !important; " >Category Order</th>
                                        ...
                                        <tbody>  	 	 	
                                             ...
                                             <?php
                                            $qry = mysql_query("select * from file_category");
                                            $tenders = mysql_fetch_array($qry);
                                          	if($tenders == '')
                                                ...
                                                $qrry = mysql_query("select * from file_category order by file_ord ");
                                        		...
                                        		?> 
                                                    <tr>
                                                        ...
                                                        <td><?php echo $tender->file_cate;?></td>
                                                        <td><?php echo $tender->file_ord;?></td>
                                                        <td align="center"><a href="admin-file-update-cate.php?action=update&id=<?php echo($tender->id);?>"><img src="images/edit.gif" border="0"/></a></td>
                                                        <td align="center"><a href="admin-filebl.php?action=delete-cate&id=<?php echo($tender->id);?>&page=" onclick="return confirmDelete();"><img src="images/delete.gif" border="0" /></a></td>
                                                    </tr>
                                                <?php 
                                                  }                                          
                                        		?>
