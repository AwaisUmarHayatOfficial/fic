          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
              ...
              <h3><center><b>Welcome</b> <span>(<?php echo $user; ?>)</span></center></h3>
                <div class="col-md-6">
                  <h3  style="font-size: 26px !important;" class="fa fa-floppy-o"> Add File Category<small> (add)</small></h3>
                </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="placeholder33" style="height: 260px; display: none" class="demo-placeholder"></div>
                         ...
                         <div class="x_content">
                                  ...
                                  <form  method="post" action="admin-filebl.php?action=add&page=<?php echo $_GET['page']; ?>" onsubmit="return myForm()" enctype="multipart/form-data" >
                                  
                                     <div class="col-md-4">
                                     <label>File Category:* <span class="error" id="error_cate"></span></label>
                                     <input class="form-control" onfocus="clr('error_cate')" type="text" id="file_cate" name="file_cate" /><br />
                                  
                                     <label>File Category Order:* <span class="error" id="error_ord"></span></label>
                                     <input class="form-control" onfocus="clr('error_ord')" type="number" id="file_ord" name="file_ord" /><br />
                                     
                                    
              
                                    <input type="submit" name="report_submit" value="Save Category" class="btn btn-primary" />
